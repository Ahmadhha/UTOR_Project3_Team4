var url='http://127.0.0.1:5000/api/v1.0/diet_disease'
...
function scatter_plotter(country_value, disease_value, diet_value) {
    d3.json(url).then(function(data) {
...
function correlation_plotter(country_value, disease_value, diet_value) {
    d3.json(url).then(function(data) {
        let diet_disease=data['diet_disease_join']
