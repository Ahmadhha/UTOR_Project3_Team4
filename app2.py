...
def database_json():
    ...
    database_dict = {"calorie_info" : [{"Entity" : row.Entity, "Code" : row.Code, "Year" : row.Year,
                    ...
                    "joined_disease_diet": [{"Entity" : row.Entity,"Code" : row.Code,"Year" : row.Year,
                                            "Other" : row.Other,"Alcohol_beverages" : row.Alcohol_beverages,"Sugar" : row.Sugar,
                                            "Oils_fats" : row.Oils_fats,"Alcohol_beverages" : row.Alcohol_beverages,"Meat" : row.Meat,
                                            "Dairy_eggs" : row.Dairy_eggs,"Fruit_vegetables" : row.Fruit_vegetables,"Starchy_roots" : row.Starchy_roots,
                                            "Pulses": row.Pulses, "Cereals_grains": row.Cereals_grains, 
                                            "Skin_and_subcutaneous_diseases": row.Skin_and_subcutaneous_diseases, "Enteric_infections": row.Enteric_infections, 
                                            "Diabetes_and_kidney_diseases": row.Diabetes_and_kidney_diseases, "Cardiovascular_diseases": row.Cardiovascular_diseases, 
                                            "Digestive_diseases": row.Digestive_diseases, "Nutritional_deficiencies": row.Nutritional_deficiencies, 
                                            "Respiratory_infections_and_tuberculosis": row.Respiratory_infections_and_tuberculosis, 
                                            "Chronic_respiratory_diseases": row.Chronic_respiratory_diseases, "Neoplasms": row.Neoplasms, 
                                            "Mental_disorders": row.Mental_disorders, "Neurological_disorders": row.Neurological_disorders, "Sense_organ_diseases": row.Sense_organ_diseases } 
                                            for row in Table6],                                        
                    }
